...
#### Install Node.js
The version of Node.js which ${this.name} supports is \`v12.x\` and has been tested against \`v12.3.1\`.
See [How to install Node.js v12.x on Ubuntu 18](https://www.digitalocean.com/community/tutorials/how-to-install-node-js-on-ubuntu-18-04#installing-using-a-ppa) and use the \`https://deb.nodesource.com/setup_12.x\` script to install Node.js.
...
The above will install the latest version of the \`v12.x\` branch of node. To get more control over the minor version (lets say you want to install \`v12.3.1\` instead of the latest) you could look at using [NVM](https://www.digitalocean.com/community/tutorials/how-to-install-node-js-on-ubuntu-18-04#installing-using-nvm) or some other Node installation mechanism.
